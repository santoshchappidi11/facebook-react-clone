...
const FriendAbout = ({ searchUser }) => {
  ...
  return (
    <>
      <div id="friend-about">
        <div id="friend-about-left">
          <h2>About</h2>
          <div id="friend-about-options">
            <h4
              onClick={handleMultiplePages}
              className={`${isShowBasicInfo ? "friend-active" : ""}`}
            >
              Contact and basic info
            </h4>
            <h4
              onClick={handleMultiplePages}
              className={`${isShowTransparencyInfo ? "friend-active" : ""}`}
            >
              Page transparency
            </h4>
          </div>
        </div>
        <div id="friend-about-right">
          {isShowBasicInfo && (
            <div id="basic-info">
              <h3>Categories</h3>
              <div>
